...
namespace RJMS.Tests
{
    public class PaymentServiceTests
    {
        ...
        public PaymentServiceTests()
        {
            ...
            _paymentService = new PaymentService(_paymentRepoMock.Object, _vnPaySvcMock.Object, _emailSvcMock.Object);
        }
        ...
        {
            // Arrange
            var plan = new SubscriptionPlan { Id = 1, Name = "Pro", Price = 100000 };
            ...
            _vnPaySvcMock.Setup(v => v.CreatePaymentUrl(10, 100, 100000, It.IsAny<string>(), "127.0.0.1")).Returns("http://vnpay");
        ...
        {
            // Arrange
            var payment = new Payment { Id = 100, SubscriptionId = 10, Amount = 100000 };
            var sub = new Subscription { Id = 10, PlanId = 1, User = new User { Email = "test@test.com" } };
            ...
            // Assert
            Assert.True(result);
            _paymentRepoMock.Verify(r => r.UpdatePaymentStatusAsync(100, "SUCCESS", "TRANS123"), Times.Once);
        ...
        public async Task ProcessPaymentFailureAsync_UpdatesStatusToFailed()
        {
            ...
            // Assert
            Assert.True(result);
            _paymentRepoMock.Verify(r => r.UpdatePaymentStatusAsync(100, "FAILED", "TRANS123"), Times.Once);
            _paymentRepoMock.Verify(r => r.UpdateSubscriptionStatusAsync(10, "CANCELLED"), Times.Once);
        }
